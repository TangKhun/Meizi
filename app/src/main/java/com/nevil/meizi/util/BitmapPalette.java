...
public abstract class BitmapPalette {
    ...
    @IntDef({BitmapPalette.Profile.VIBRANT, BitmapPalette.Profile.VIBRANT_DARK, BitmapPalette.Profile.VIBRANT_LIGHT,
            BitmapPalette.Profile.MUTED, BitmapPalette.Profile.MUTED_DARK, BitmapPalette.Profile.MUTED_LIGHT})
    ...
    @IntDef({BitmapPalette.Swatch.RGB, BitmapPalette.Swatch.TITLE_TEXT_COLOR, BitmapPalette.Swatch.BODY_TEXT_COLOR})
    @Retention(RetentionPolicy.SOURCE)
    ...
    private BitmapPalette.PaletteBuilderInterceptor interceptor;
    private boolean skipCache;

    public BitmapPalette use(@BitmapPalette.Profile int paletteProfile) {
        this.targets.add(new PaletteTarget(paletteProfile));
        return this;
    }

    protected BitmapPalette intoBackground(View view, @BitmapPalette.Swatch int paletteSwatch) {
    ...
    protected BitmapPalette intoTextColor(TextView textView, @BitmapPalette.Swatch int paletteSwatch) {
        assertTargetsIsNotEmpty();
    ...
    protected BitmapPalette setPaletteBuilderInterceptor(BitmapPalette.PaletteBuilderInterceptor interceptor) {
    ...
    protected void apply(Palette palette, boolean cacheHit) {
        ...
        for (PaletteTarget target : targets) {
            ...
            switch (target.paletteProfile) {
                case BitmapPalette.Profile.VIBRANT:
                    swatch = palette.getVibrantSwatch();
                    break;
                case BitmapPalette.Profile.VIBRANT_DARK:
                    swatch = palette.getDarkVibrantSwatch();
                    break;
                case BitmapPalette.Profile.VIBRANT_LIGHT:
                    swatch = palette.getLightVibrantSwatch();
                    break;
                case BitmapPalette.Profile.MUTED:
                    swatch = palette.getMutedSwatch();
                    break;
                case BitmapPalette.Profile.MUTED_DARK:
                    swatch = palette.getDarkMutedSwatch();
                    break;
                case BitmapPalette.Profile.MUTED_LIGHT:
    ...
    protected static int getColor(Palette.Swatch swatch, @BitmapPalette.Swatch int paletteSwatch) {
        if (swatch != null) {
